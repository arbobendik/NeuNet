...
setTimeout(() => {
  ...
  console.log("Timings for " + neuron_runs + " test runs in a row.")
  console.log("Neuron accuracy: " + (correct_neuron / neuron_runs) * 100 + "%");
